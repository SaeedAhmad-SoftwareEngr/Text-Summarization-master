...
[docs]class HTMLHeaderTextSplitter:
    """
...
[docs]    def aggregate_elements_to_chunks(
...
[docs]    def split_text_from_url(self, url: str) -> List[Document]:
...
[docs]    def split_text_from_file(self, file: Any) -> List[Document]:
        """Split HTML file
